...
import CurrencySelector from "../Shared/Currency";
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* ── Totals Summary ── */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-linear-to-r from-[#5247bf]/10 to-[#4238a6]/10 rounded-lg border border-[#5247bf]/20">
          <div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
            ...
            <p className="text-gray-600 mb-8 font-medium">
              You have used all <strong>{limitStatus.limit}</strong> free
              budgets. Upgrade to Pro for unlimited budgets and full management.
            </p>
            <button
