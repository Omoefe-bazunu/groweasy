    ...
    <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="bg-violet-50 border border-violet-200 rounded-xl p-6 text-center">
        ...
        <p className="text-violet-700 mt-2">
          ...
          for sale. Managing it well ensures you do not run out of popular items
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              You do npt need to edit a product to change its quantity. Use the{" "}
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              ...
              badge for -Low Stock- when an item&apos;s quantity drops below the
              -Min Level- you set. This is your signal to re-order immediately.
            </p>
          </div>
        </div>
      </div>
