...
export default function AdminDashboard() {
  ...
  const handleExperts = () => router.push("/admin/add-expert");
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-yellow-400/20">
          <button
            ...
            className="w-full flex justify-between items-center p-6 bg-linear-to-r from-yellow-500 to-orange-500 text-white text-xl font-bold hover:opacity-90 transition"
          >
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden text-gray-700">
          <button
            ...
            className="w-full flex justify-between items-center p-6 bg-linear-to-r from-gray-800 to-gray-900 text-white text-xl font-bold hover:opacity-90 transition"
          >
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden text-gray-700">
          <button
            ...
            className="w-full flex justify-between items-center p-6 bg-linear-to-r from-[#5247bf] to-[#4238a6] text-white text-xl font-bold hover:opacity-90 transition"
          >
            <span className="flex items-center gap-3">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-indigo-400/20">
          <button
            ...
            className="w-full flex justify-between items-center p-6 bg-linear-to-r from-indigo-600 to-blue-600 text-white text-xl font-bold hover:opacity-90 transition"
          >
            <span className="flex items-center gap-3">
