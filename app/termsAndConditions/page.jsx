      ...
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-200">
        ...
        <div className="p-6 md:p-12 space-y-10">
          ...
          <section>
            ...
            <p className="leading-relaxed font-medium text-gray-700">
              GrowEasy is provided as-is. HIGH-ER ENTERPRISES is not liable for
              any financial losses, data inaccuracies, or business interruptions
              resulting from the use of our document generation or bookkeeping
              tools. Users are encouraged to double-check all generated values
