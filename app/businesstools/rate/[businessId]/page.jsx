...
// Hook change: import from next/navigation
...
const PublicRate = () => {
  // useParams works the same way, just a different source
  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#5247bf] p-6 text-gray-700">
        <div className="bg-white p-12 rounded-[3rem] shadow-2xl text-center">
          ...
          <p className="text-gray-500 mt-2">
            Thanks for helping GrowEasy expand.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#5247bf] flex items-center justify-center p-6 text-gray-700">
      <div className="bg-white w-full max-w-md rounded-[3rem] shadow-2xl overflow-hidden p-8">
        ...
        <p className="text-gray-400 text-center text-sm mb-8">
          Your feedback helps us simplify business.
        </p>
