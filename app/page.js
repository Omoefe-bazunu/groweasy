...
import onboardImg from "../public/onboard.png";
...
const Onboarding = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 animate-in fade-in duration-500 font-sans">
      <Image
        src={onboardImg}
        alt="Onboarding Illustration"
        className="w-3/4 max-w-md mb-8 h-auto"
        priority
        placeholder="blur"
      />
