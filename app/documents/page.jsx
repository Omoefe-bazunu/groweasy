  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-32 pt-8 px-4 md:px-12 text-gray-700">
      ...
      <div className="bg-[#5247bf] rounded-2xl p-8 mb-10 max-w-6xl mx-auto shadow-xl text-center">
        ...
        <p className="text-indigo-100 max-w-xl mx-auto text-sm opacity-90">
          Essential legal and operational documents required for a compliant
          business in Nigeria.
        </p>
      </div>
