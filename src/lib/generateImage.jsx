...
export const generateImage = async ({ prompt, style, size }) => {
  ...
  const styledPrompt = `First modify the prompt "${prompt}" to be perfectly descriptive then generate a image of the modified prompt, in the correct style of ${style.name.toLowerCase()}. Make sure the images perfectly match the descriptions and the style. Readable texts, no spelling mistakes. Do a neat job`;
