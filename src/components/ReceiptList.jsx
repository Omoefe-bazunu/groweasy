          ...
          <tfoot>
            ...
            ${
              ...
              <tr>
                ...
                <td style="padding: 8px; text-align: right; font-weight: 600; border: 1px solid #ddd;">₦${parseFloat(calculateInterestCharges(receipt)).toLocaleString("en-NG", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
              </tr>
            `
                : ""
            }
