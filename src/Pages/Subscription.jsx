...
export default function Subscription() {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-4xl mx-auto px-6 pt-10 pb-25 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 border rounded-xl shadow-md bg-white">
              ...
              <p className="text-gray-600 mb-4">
                5 images, 5 content plans/month
              </p>
              <p className="text-gray-800 font-bold">Free</p>
              <p className="text-gray-500 mt-2">Current Plan</p>
            </div>
            <div className="p-6 border flex flex-col rounded-xl shadow-md bg-white">
              <h2 className="text-xl font-semibold text-gray-800 mb-2">
                Growth
              </h2>
              <p className="text-gray-600 mb-4 flex-grow">
                30 images, 60 content plans/month
              </p>
              <p className="text-gray-800 font-bold">
                $10.71 (NGN14,999)/month
              </p>
              <button
            ...
            <div className="p-6 border flex flex-col rounded-xl shadow-md bg-white">
              ...
              <p className="text-gray-600 mb-4 flex-grow">
                70 images, 100 content plans/month
              </p>
              <p className="text-gray-800 font-bold">
                $17.86 (NGN24,999)/month
              </p>
              <button
          ...
          {selectedPlan && (
            <div className="bg-white p-6 rounded-xl shadow-md space-y-6 mt-8">
              ...
              <div>
                ...
                >
                  {showLocal ? "Hide" : "Show"} Local Transfer (Nigeria)
                </button>
                {showLocal && (
              ...
              <div>
                <button
                  ...
                  className="w-full text-left py-3 px-4 rounded-xl bg-gray-100 hover:bg-gray-200 font-medium text-gray-700 transition-all duration-200"
                >
                  {showInternational ? "Hide" : "Show"} International Transfer
                  (USD)
                </button>
                {showInternational && (
                  <div className="p-4 border rounded-xl text-gray-700 space-y-2 mt-2">
                    <p>Bank: Lead Bank</p>
