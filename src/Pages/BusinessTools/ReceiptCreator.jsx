...
//                     </tr>
//                   )}
//                   {formData.interestRate && calculateInterestCharges() > 0 && (
//                     <tr>
//                       <td colSpan="5" className="p-2 text-right font-bold">
//                         Interest Charges:
//                       </td>
...
const ReceiptCreator = () => {
  ...
  const handleSave = async () => {
    ...
    if (!hasAccessToCreate()) {
      ...
      toast.error(
        daysLeft > 0
          ? `Your trial has expired. You have ${daysLeft} trial days remaining.`
          : "Please subscribe to create receipts."
      );
      return;
    }
      ...
      <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-lg p-8 text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            {daysLeft > 0
              ? `Your trial has ${daysLeft} days remaining. Subscribe to continue creating receipts.`
              : "Your trial has expired. Please subscribe to create receipts."}
          </p>
          <Link
            to="/subscribe"
