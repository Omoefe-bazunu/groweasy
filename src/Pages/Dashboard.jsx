...
// import { FileText, User, File, CreditCard } from "lucide-react";
...
//             </h2>
//           </div>
//           <button className="bg-[#5247bf] w-24 text-white px-4 py-2 rounded-lg hover:bg-[#4238a6] transition-all duration-200">
//             Create
//           </button>
//         </div>
...
//               Current Plan: {subscription.plan} <br /> ({subscription.status})
//             </p>
//           </div>
//           <button className="bg-[#5247bf] w-24 text-white px-4 py-2  rounded-lg hover:bg-[#4238a6] transition-all duration-200">
